    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/cvsu/login/**", "/cvsu/displayBldgAndRooms/**", "/cvsu/displayAllBldgAndRooms/**", "/cvsu/validate/**", "/cvsu/submitFeedback/**", "/cvsu/findMyAccount/**", "/cvsu/recoverPassword/**").permitAll()
